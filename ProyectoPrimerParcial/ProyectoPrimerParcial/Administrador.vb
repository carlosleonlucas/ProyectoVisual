...
Public Class Administrador
    ...
    Public Sub listarRestaurantes(lista As ArrayList, listausu As ArrayList)
        ...
        For Each res As Restaurante In lista
            ...
            Console.WriteLine("**                                       **")
            Console.WriteLine("**                                       **")
            Console.WriteLine("* Nombre:".PadRight(16) + res.Nombre)
            ...
            For Each plati As Platillo In res.Platillos
                Console.WriteLine("*    Nombre:".PadRight(22) + plati.Nombre)
                Console.WriteLine("*    Descripción:".PadRight(22) + plati.Descripcion)
                Console.WriteLine("*    Categoria:".PadRight(22) + plati.Categoria.Nombre)
                Console.WriteLine("*    Tipo:".PadRight(22) + plati.Tipo)
                Console.WriteLine("**                                       **")
                Console.WriteLine("**                                       **")
            Next
